---
layout: default
title: Tiation Github Pages Theme - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Github Pages Theme</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-github-pages-theme" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-github-pages-theme .

# Run container
docker run -p 8080:8080 tiation-github-pages-theme
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-github-pages-theme)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-github-pages-theme/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-github-pages-theme/discussions)
